  ...
  },
  {
    ...
    config: {
      ...
      options: [
        ...
        { key: '9', label: 'T-shirt' },
        { key: '10', label: 'Πουκάμισα' },
        { key: '11', label: 'Αθλητικά' },
        { key: '12', label: 'Μποτάκια' },
        { key: '13', label: 'Μπότες' },
        { key: '14', label: 'Γόβες' },
        { key: '15', label: 'Φλατ' },
        { key: '16', label: 'Σανδάλια' },
        { key: '17', label: 'Πέδιλα' },
        { key: '18', label: 'Σαγιονάρες' },
        { key: '19', label: 'Βραχιόλια' },
        { key: '20', label: 'Κολιέ' },
        { key: '21', label: 'Σκουλαρήκια' },
        { key: '22', label: 'Δαχτυλίδια' },
        { key: '23', label: 'Αξεσουάρ μαλλιών' },
      ],
    },
  },
  {
...
export const sortConfig = {
  ...
  options: [
    { key: 'createdAt', label: 'Νεότερα' },
    { key: '-createdAt', label: 'Παλαιότερα' },
    { key: '-price', label: 'Χαμηλότερη τιμή' },
    { key: 'price', label: 'Υψηλότερη τιμή' },
